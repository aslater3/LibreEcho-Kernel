...
class EchoRawFiqStageContract(unittest.TestCase):
    ...
    def test_no_custom_stage_selftest_or_cleanup_writer_remains(self):
        self.assertNotIn("echo_stage_selftest", RAM)
        self.assertNotIn("echo_stage_set(", GL)
        self.assertNotIn("echo_stage_set(", OPEN)
